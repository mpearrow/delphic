<div id="container"> 
  ...
  <div id="page-top">
    <div id="header-wrapper"> 
      ...
      <div id="header">
        <div id="logo">
	<a href="index.html"><img src="images/logo.png" alt="Delphic" /></a>
	</div>
        <!-- Logo --> 
        <!-- Begin Menu -->
        <div id="menu-wrapper">
...
<div id="footer-wrapper">
  <div id="footer">
    <div id="footer-content"> 
      ...
      <div id="socials">
        <ul>
          <li><a href="#"><img src="sites/all/themes/delphic/images/icon-rss.png" alt="" /></a></li>
          <li><a href="#"><img src="sites/all/themes/delphic/images/icon-twitter.png" alt="" /></a></li>
          <li><a href="#"><img src="sites/all/themes/delphic/images/icon-dribble.png" alt="" /></a></li>
          <li><a href="#"><img src="sites/all/themes/delphic/images/icon-tumblr.png" alt="" /></a></li>
          <li><a href="#"><img src="sites/all/themes/delphic/images/icon-flickr.png" alt="" /></a></li>
          <li><a href="#"><img src="sites/all/themes/delphic/images/icon-facebook.png" alt="" /></a></li>
        </ul>
      </div>
      <!-- End Social Icons --> 
